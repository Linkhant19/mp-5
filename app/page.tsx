  ...
  return (
    <div className="flex flex-col items-center">
      <p className="text-sm p-10 pl-50 pr-50 text-blue-700 dark:text-sky-400 font-mono font-semibold">
        is your url too long? are there many many unnecessary characters that you don't need in that little link of yours? 
        are you stressed that your link wouldn't fit into a little text box? 
